export class NgxWeb3LoginModalContent extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.shadowRoot.innerHTML = `
      ...
      <div class="modal-container">
        <div class="modal-option" data-option="metamask">
        ...
        <div class="modal-option" data-option="walletconnect">
